        ...
        <div className="bg-white rounded-2xl shadow-sm border border-sage-200 p-8">
          {sent ? (
            <div className="text-center">
              <div className="w-14 h-14 bg-tmc-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
              ...
              <Link href="/auth/login" className="text-tmc-600 hover:text-tmc-700 font-medium text-sm">
                ← Back to sign in
              </Link>
            </div>
          ) : (
            <>
              ...
              <p className="text-center text-sm text-sage-500 mt-6">
                <Link href="/auth/login" className="text-tmc-600 hover:text-tmc-700 flex items-center justify-center gap-1">
                  <ArrowLeft size={14} />
                  Back to sign in
                </Link>
              </p>
